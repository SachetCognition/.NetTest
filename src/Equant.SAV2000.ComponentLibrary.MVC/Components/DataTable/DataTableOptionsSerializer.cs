    ...
    public class DataTableOptionsSerializer
    {
            ...
            foreach (var column in this.dataTableComponent.Columns)
            {
                ...
                this.columns.Add(
                    new DataTableColumnsOption
                    {
                        ...
                        Data = string.IsNullOrEmpty(column.PropertyName)
                            ? null
            ...
            return JsonConvert.SerializeObject(
                new
                {
                    ...
                    remove = dataTableComponent.IsDeleteNeeded ? new
                    {
                        ...
                        delete2 = dataTableComponent.IsDeleteNeeded,
                    ...
                    modify = dataTableComponent.IsModifyNeeded ? new
                    {
                        ...
                        modify2 = dataTableComponent.IsModifyNeeded,
                    ...
                    selection = dataTableComponent.IsSelect ? new
                    {
                        rowIdColumnName = dataTableComponent.RowIdColumnName,
        ...
        private DataTableOptions SerializeDataTableInit()
        {
            ...
            return new DataTableOptions
            {
                ...
                ServerParams = string.IsNullOrEmpty(dataTableComponent.OnServerParams) ? null : new JRaw(dataTableComponent.OnServerParams),
                ...
                Language = new DataTableLanguageOption
                {
                    ...
                    Paginate = new DataTableLanguagePaginateOption
                    {
                        First = Common.Resources.ApplicationStrings.TIP000012,
                        Last = Common.Resources.ApplicationStrings.TIP000014,
                        Next = Common.Resources.ApplicationStrings.TIP000011,
                        Previous = Common.Resources.ApplicationStrings.TIP000013
                    },
                    Aria = new DataTableLanguageAriaOption
                    {
                        SortAscending = string.Format(CultureInfo.InvariantCulture, ": {0}", Common.Resources.ApplicationStrings.LBL000027),
                        SortDescending = string.Format(CultureInfo.InvariantCulture, ": {0}", Common.Resources.ApplicationStrings.LBL000028)
                    },
