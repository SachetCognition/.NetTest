namespace Equant.SAV2000.ComponentLibrary.MVC.Components.DateTimeControl
{
    ...
    public class DateTimeWithFormat
    {
        ...
        public bool IsModel { get { return this.isModel; } }
        ...
        {
            get { return this.hourValue; }
            set
            {
                if (value == null) return;
                if (string.IsNullOrEmpty(value)) { this.hourValue = value; return; }
                int hourParsed;
        ...
        {
            get { return this.minuteValue; }
            set
            {
                if (value == null) return;
                if (string.IsNullOrEmpty(value)) { this.minuteValue = value; return; }
                int minuteParsed;
