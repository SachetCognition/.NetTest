namespace Equant.SAV2000.ComponentLibrary.MVC.Components.SpanLabel
{
    ...
    public class SpanLabelBuilder : ComponentBuilderBase<SpanLabelComponent, SpanLabelBuilder>
    {
        ...
        public SpanLabelBuilder Text(string value) { Component.Text = value; return this; }
        public SpanLabelBuilder CssClass(string value) { Component.CssClass = value; return this; }
    }
}
